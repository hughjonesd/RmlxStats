...
We benchmark RmlxStats against standard R functions and
specialized fast fitting packages across varying dataset sizes of
cases (`n`) and predictors (`p`).
