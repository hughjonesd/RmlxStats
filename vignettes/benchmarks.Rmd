...
base_comparison$speedup <- base_comparison$base_time/base_comparison$mlxs_time
...
fastest_comparison$speedup <- fastest_comparison$fastest_time/fastest_comparison$mlxs_time
...
knitr::kable(base_table, digits = 1,
             caption = "RmlxStats vs Base R. Above 1 → RmlxStats faster",
             format = "pipe")

knitr::kable(fastest_table, digits = 1,
             caption = "RmlxStats vs Fastest Alternative. Above 1 → RmlxStats faster",
             format = "pipe")
```
...
```{r plot-bootstrap, include = FALSE}
